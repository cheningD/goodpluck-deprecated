...
export default function Returns() {
  return (
    <>
      ...
      <p>
        If there is a problem with your order, or you simply wish to give feedback, email us at help@goodpluck.com. We
        love hearing from you, the good and the bad. And if it's bad news we will do everything we can to make it right!
      </p>
      <h2>Returns</h2>
      <p>
        Goodpluck does not accept returns or exchanges of any products once they have shipped. This helps us get you the
        freshest foods possible
      </p>
      <h2>Refunds and Credits</h2>
      <p>
        If you have any issue with your order, please let us know by emailing help@goodpluck.com. Do this within 7 days
        of your delivery date, as we cannot offer refunds or credits after this time.
      </p>
      <p>
        If you have missing products or an issue with your order we may, at our sole discretion, give you credit for the
        product and, in some situations, offer a full or partial refund.
      </p>
      <p>
