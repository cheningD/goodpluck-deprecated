...
export interface OrderSupabaseInput {
  user_id: string // fkey to user table
  order_index: string // YYYY-MM-DD
  charged_date: string //timestamptz in postgres, ISO String returned
  delivery_date: string //timestamptz in postgres, ISO String returned
  ...
  delivered: boolean
  edit_start_date: string //timestamptz in postgres, ISO String returned
  edit_end_date: string //timestamptz in postgres, ISO String returned
}
export interface OrderSupabase extends OrderSupabaseInput {
  id: string // uuid generated by supabase
  created_at: string //timestamptz in postgres, ISO String returned
}
